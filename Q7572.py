...
TenHeavenlyStems = [str(i) for i in range(10)]
TwelveEarthlyBranches = [chr(i) for i in range(65, 77)]

print(TwelveEarthlyBranches[(year + 5) % 12] + TenHeavenlyStems[(year + 9) % 10])